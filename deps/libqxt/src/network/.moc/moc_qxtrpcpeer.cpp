...
**
** Created: Mon May 3 17:55:46 2010
...
int QxtRPCPeer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: connectedToServer(); break;
        case 1: disconnectedFromServer(); break;
        case 2: serverError((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
