...
**
** Created: Mon May 3 17:54:11 2010
...
const QMetaObject QxtLoggerPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QxtLoggerPrivate,
      qt_meta_data_QxtLoggerPrivate, 0 }
};
...
int QxtLoggerPrivate::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: log((*reinterpret_cast< QxtLogger::LogLevel(*)>(_a[1])),(*reinterpret_cast< const QList<QVariant>(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
