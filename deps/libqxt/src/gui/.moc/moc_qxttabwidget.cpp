...
**
** Created: Mon May 3 17:55:17 2010
...
int QxtTabWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: tabContextMenuRequested((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QPoint(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
        ...
        case 2: *reinterpret_cast< TabMovementMode*>(_v) = tabMovementMode(); break;
        }
        _id -= 3;
        ...
        case 2: setTabMovementMode(*reinterpret_cast< TabMovementMode*>(_v)); break;
        }
        _id -= 3;
